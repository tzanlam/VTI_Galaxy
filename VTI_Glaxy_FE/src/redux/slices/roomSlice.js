...
export const fetchRoomById = createAsyncThunk('room/fetchRoomById', async(roomId, {rejectWithValue})=>{
   try{
...
export const fetchRoomByGalaxy = createAsyncThunk('room/fetchRoomByGalaxyId', async(galaxyId, {rejectWithValue})=>{
   try{
...
export const createRoom = createAsyncThunk('room/createRoom', async(request, {rejectWithValue})=>{
   try{
...
export const updateRoom = createAsyncThunk('room/updateRoom', async({roomId, request}, {rejectWithValue})=>{
   try{
